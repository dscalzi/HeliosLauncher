    ...
    Array.from(document.getElementsByClassName('settingsAuthAccountLogOut')).map((val) => {
        val.onclick = (e) => {
            ...
            if(Object.keys(ConfigManager.getAuthAccounts()).length === 1){
                isLastAccount = true
                setOverlayContent(
                    'Attention !<br>Ceci est votre dernier compte Minecraft.',
                    'Pour utiliser le launcher, vous devez êtres connecté à au moins un compte Minecraft. Vous devrez vous reconnecter après.<br><br>Etes-vous sûr de vouloir vous déconnecter ?',
                    'Je suis sûr de moi',
                    'Annuler'
                )
                setOverlayHandler(() => {
...
function refreshAuthAccountSelected(uuid){
    Array.from(document.getElementsByClassName('settingsAuthAccount')).map((val) => {
        ...
        if(uuid === val.getAttribute('uuid')){
            ...
            selBtn.innerHTML = 'Séléctionner ce compte'
        }
    })
}
            ...
            <div class="settingsAuthAccountRight">
                <div class="settingsAuthAccountDetails">
                    <div class="settingsAuthAccountDetailPane">
                        <div class="settingsAuthAccountDetailTitle">Pseudonyme</div>
                ...
                <div class="settingsAuthAccountActions">
                    <button class="settingsAuthAccountSelect" ${selectedUUID === acc.uuid ? 'selected>Compte Séléctionné &#10004;' : '>Séléctionner ce compte'}</button>
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/PinkFloyd1213/Creeponnia-Launcher/releases.atom',
        success: (data) => {
