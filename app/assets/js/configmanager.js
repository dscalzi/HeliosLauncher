...
const dataPath = path.join(sysRoot, ".opbluesea");
...
/**
 * Check if the launcher should play music.
 *
 * @param {boolean} def Optional. If true, the default value will be used.
 */
exports.getAllowMusic = function (def = false) {
  return !def
    ? config.settings.launcher.music
    : DEFAULT_CONFIG.settings.launcher.music;
};

/**
 * Change the status of whether or not the launcher should play music.
 *
 * @param {boolean} allowMusic Whether or not the launcher should play music.
 */
exports.setAllowMusic = function (allowMusic) {
  config.settings.launcher.music = allowMusic;
};

/**
 * Changer music volumne.
 *
 * @param {boolean} def Optional. If true, the default value will be used.
 */
exports.getMusicVolume = function (def = false) {
  return !def
    ? config.settings.launcher.musicVolume
    : DEFAULT_CONFIG.settings.launcher.musicVolume;
};

/**
 * Change the music volume.
 *
 * @param {number} volume The new music volume.
 */
exports.setMusicVolume = function (volume) {
  config.settings.launcher.musicVolume = volume;
};
