...
<div id="loginOptionsContainer" in:fade="{{ delay: 500 }}" out:fade>
    ...
    <div class="loginOptionsMainContent">
      ...
      <div class="loginOptionActions">
        <div class="loginOptionButtonContainer">
          <button
            id="loginOptionMicrosoft"
            class="loginOptionButton"
            on:click="{(e) => currentView.set(PossibleViewState.MicrosoftLogin)}"
          >
        ...
        <div class="loginOptionButtonContainer">
          <button
            id="loginOptionMojang"
            class="loginOptionButton"
            on:click="{(e) => currentView.set(PossibleViewState.Login)}"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 9.677 9.667">
              <path d="M-26.332-12.098h2.715c-1.357.18-2.574 1.23-2.715 2.633z" fill="#fff"></path>
              <path
