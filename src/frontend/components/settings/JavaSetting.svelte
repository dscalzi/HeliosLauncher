...
<div id="settingsTabJava" class="settingsTab" in:fade="{{ delay: 250, duration: 250 }}" out:fade="{{ duration: 250 }}">
  ...
  <div id="settingsMemoryContainer">
    ...
    <div id="settingsMemoryContent">
      <div id="settingsMemoryContentLeft">
        ...
        <div id="settingsMemoryDesc">
          The recommended minimum RAM is 3 gigabytes. Setting the minimum and maximum values to the same value may
          reduce lag.
        </div>
      </div>
  ...
  <div class="settingsFileSelContainer">
    ...
    <div class="settingsFileSelContent">
      ...
      <div class="settingsFileSelActions">
        ...
        <input
          class="settingsFileSelVal"
          id="settingsJavaExecVal"
          type="text"
          value="null"
          cValue="JavaExecutable"
          serverDependent
          disabled
        />
        <button
          class="settingsFileSelButton"
          id="settingsJavaExecSel"
          dialogTitle="Select Java Executable"
          dialogDirectory="false">Choose File</button
        >
      </div>
    </div>
    <div class="settingsFileSelDesc">
      The Java executable is validated before game launch. <strong id="settingsJavaReqDesc">Requires Java 8 x64.</strong
      ><br />The path should end with <strong>process.platform === 'win32' ? '\\javaw.exe' : '/java'</strong>.
    </div>
  </div>
  <div id="settingsJVMOptsContainer">
    ...
    <div id="settingsJVMOptsDesc">
      Options to be provided to the JVM at runtime. <em>-Xms</em> and <em>-Xmx</em> should not be included.<br /><a
        href="https://docs.oracle.com/javase/8/docs/technotes/tools/<%= process.platform === 'win32' ? 'windows' : 'unix' %>/java.html"
        id="settingsJvmOptsLink">Available Options for Java 8</a
      >.
    </div>
  </div>
</div>
